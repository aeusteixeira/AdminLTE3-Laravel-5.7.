        ...
        <div class="card-header">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea required type="text" name="description" class="form-control" id="description" placeholder="Usuários com esse nível... vendem"></textarea>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
            ...
            <div class="card-body">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="checkbox" value="1" name="marketing" class="custom-control-input" id="marketing">
                            <label class="custom-control-label" for="marketing">Marketing</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="administrative" class="custom-control-input" id="administrative">
                            <label class="custom-control-label" for="administrative">Administrativo</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="units" class="custom-control-input" id="units">
                            <label class="custom-control-label" for="units">Unidade</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="sales" class="custom-control-input" id="sales">
                            <label class="custom-control-label" for="sales">Vendas</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="sales_manager" class="custom-control-input" id="sales_manager">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_user" class="custom-control-input" id="create_user">
                            <label class="custom-control-label" for="create_user">Criar usuário</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_user" class="custom-control-input" id="update_user">
                            <label class="custom-control-label" for="update_user">Editar usuário</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_user" class="custom-control-input" id="delete_user">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_register" class="custom-control-input" id="create_register">
                            <label class="custom-control-label" for="create_register">Criar registro</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_register" class="custom-control-input" id="update_register">
                            <label class="custom-control-label" for="update_register">Editar registro</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_register" class="custom-control-input" id="delete_register">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_level" class="custom-control-input" id="create_level">
                            <label class="custom-control-label" for="create_level">Criar nível</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_level" class="custom-control-input" id="update_level">
                            <label class="custom-control-label" for="update_level">Editar nível</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_level" class="custom-control-input" id="delete_level">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_unit" class="custom-control-input" id="create_unit">
                            <label class="custom-control-label" for="create_unit">Criar unidade</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_unit" class="custom-control-input" id="update_unit">
                            <label class="custom-control-label" for="update_unit">Editar unidade</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_unit" class="custom-control-input" id="delete_unit">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_layout" class="custom-control-input" id="create_layout">
                            <label class="custom-control-label" for="create_layout">Criar layout</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_layout" class="custom-control-input" id="update_layout">
                            <label class="custom-control-label" for="update_layout">Editar layout</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_layout" class="custom-control-input" id="delete_layout">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_campaign" class="custom-control-input" id="create_campaign">
                            <label class="custom-control-label" for="create_campaign">Criar campanha</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_campaign" class="custom-control-input" id="update_campaign">
                            <label class="custom-control-label" for="update_campaign">Editar campanha</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_campaign" class="custom-control-input" id="delete_campaign">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_email" class="custom-control-input" id="create_email">
                            <label class="custom-control-label" for="create_email">Criar e enviar e-mail</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_email" class="custom-control-input" id="delete_email">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_post" class="custom-control-input" id="create_post">
                            <label class="custom-control-label" for="create_post">Criar postagens</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_post" class="custom-control-input" id="update_post">
                            <label class="custom-control-label" for="update_post">Editar postagens</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_post" class="custom-control-input" id="delete_post">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="create_message" class="custom-control-input" id="create_message">
                            <label class="custom-control-label" for="create_message">Criar mensagens</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="update_message" class="custom-control-input" id="update_message">
                            <label class="custom-control-label" for="update_message">Editar mensagens</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="delete_message" class="custom-control-input" id="delete_message">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="spreadsheet_import" class="custom-control-input" id="spreadsheet_import">
                            <label class="custom-control-label" for="spreadsheet_import">Importar planilha de para o sistema</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="spreadsheet_generate" class="custom-control-input" id="spreadsheet_generate">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="print_screen" class="custom-control-input" id="print_screen">
                            <label class="custom-control-label" for="print_screen">Usuário conseguirá tirar PrintScreen de páginas do sistema</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="printer" class="custom-control-input" id="printer">
                ...
                <div class="card card-outline card-success">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                            <input type="checkbox" value="1" name="administrator" class="custom-control-input" id="administrator">
...
<div class="card-footer">
    <button type="submit" class="btn btn-success">Cadastrar nível</button>
