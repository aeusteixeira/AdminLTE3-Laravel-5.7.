        ...
        <div class="card-header">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input required type="text" name="name" class="form-control" id="name" placeholder="Ex: NOME | E-MAIL | TELEFONE">
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-lg-4">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                <input type="checkbox" value="1" name="courses_input" class="custom-control-input" id="courses_input">
...
<div class="card-footer">
    <button type="submit" class="btn btn-success">Cadastrar layout</button>
